...
- (NSString *)formatMinutesAgo:(NSTimeInterval)secondsSince
{
    ...
    if(minutesSince == 1)
        ...
        return [NSString stringWithFormat:@"%d분 전", minutesSince];
}
...
- (NSString *)formatAsToday:(NSTimeInterval)secondsSince
{
    ...
    if(hoursSince == 1)
        ...
        return [NSString stringWithFormat:@"%d시간 전", hoursSince];
}
...
- (NSString *)formatAsYesterday
{
    ...
    return [NSString stringWithFormat:@"어제 %@", [dateFormatter stringFromDate:self]];
}
...
- (NSString *)formatAsLastWeek
{
    ...
    //Format
    [dateFormatter setDateFormat:@"EEEE a h:mm "];
...
- (NSString *)formatAsLastMonth
{
    ...
    //Format
    [dateFormatter setDateFormat:@"MMMM d일 a h:mm "];
    return [dateFormatter stringFromDate:self];
}
...
- (NSString *)formatAsLastYear
{
    ...
    //Format
    [dateFormatter setDateFormat:@"MMMM d일"];
    return [dateFormatter stringFromDate:self];
}
...
- (NSString *)formatAsOther
{
    ...
    //Format
    [dateFormatter setDateFormat:@"LLLL d일, yyyy"];
    return [dateFormatter stringFromDate:self];
}
